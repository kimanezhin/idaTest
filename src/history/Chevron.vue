...
export default {
  ...
  mounted() {
    this.parentNode = document.getElementsByClassName(this.node)[0];
    this.domNode = this.parentNode.querySelector('svg')
  ...
  beforeDestroy() {
    this.parentNode.removeEventListener("click", this.rotate);
  }
};
</script>
<style scoped>
